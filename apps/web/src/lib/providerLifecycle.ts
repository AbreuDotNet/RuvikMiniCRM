// AUTO-MIRRORED from apps/api/src/lib/providerLifecycle.ts.
// The admin UI renders its buttons from this table and the API enforces the
// same one; `providerLifecycleParity.test.ts` fails if they ever differ.
/**
